...
- (UILabel *)titleLabel
{
    if (!_titleLabel) {
        ...
        _titleLabel.font = [UIFont boldSystemFontOfSize:[ChatTableViewCell defaultFontSize]];
    }
    return _titleLabel;
}
...
- (UILabel *)bodyLabel
{
    if (!_bodyLabel) {
        ...
        _bodyLabel.font = [UIFont systemFontOfSize:[ChatTableViewCell defaultFontSize]];
    }
    return _bodyLabel;
}
